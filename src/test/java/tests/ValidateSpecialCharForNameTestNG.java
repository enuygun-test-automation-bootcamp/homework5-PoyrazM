...
public class ValidateSpecialCharForNameTestNG extends BaseTest {
    ...
    // Bu test case'm isim fieldına özel karakter göndermek için yazılmıştır.
    @Test(priority = 5)
    public void validateContactName(){
        try {
            ...
            contactPage.sendKeysToContactName("*&%-_");
        }catch (NoSuchElementException exception){
    ...
    public void validateContactPhone(){
        try {
            ...
            contactPage.sendKeysToContactPhone("636363647");
        }catch (NoSuchElementException exception){
    ...
    public void validateContactEmail(){
        try {
            ...
            contactPage.sendKeysToContactEmail("test6@mail.com");
        }catch (NoSuchElementException exception){
