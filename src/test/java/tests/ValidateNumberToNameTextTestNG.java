...
public class ValidateNumberToNameTextTestNG extends BaseTest {
    ...
    // Bu test sınıfımda , test case'm isim alanına numara göndermekti
    @Test(priority = 5)
    public void validateContactName(){
        try {
            ...
            contactPage.sendKeysToContactName("25252525");
        }catch (NoSuchElementException exception){
    ...
    public void validateContactPhone(){
        try {
            ...
            contactPage.sendKeysToContactPhone("56563434");
        }catch (NoSuchElementException exception){
    ...
    public void validateContactEmail(){
        try {
            ...
            contactPage.sendKeysToContactEmail("test5@mail.com");
        }catch (NoSuchElementException exception){
    ...
    public void validateChecksNewContact(){
        try{
            ...
            Assert.assertEquals(homePage.dynamicCheckSavedName("25252525").getText(),"25252525");
        }catch (NoSuchElementException exception){
