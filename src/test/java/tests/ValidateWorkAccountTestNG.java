...
public class ValidateWorkAccountTestNG extends BaseTest {
    ...
    public void validateContactName(){
        try {
            ...
            contactPage.sendKeysToContactName("work account");
        }catch (NoSuchElementException exception){
    ...
    public void validateContactPhone(){
        try {
            ...
            contactPage.sendKeysToContactPhone("0525252525");
        }catch (NoSuchElementException exception){
    ...
    // Phone Field'ın yanındaki Spinner'ı açıp accountu Work seçerek kaydetme kontrolü
    @Test(priority = 7)
    public void validateWorkForContactPhone(){
        try{
            contactPage.clickToPhoneSpinner();
            Assert.assertEquals(contactPage.getAlertTitleText().getText(),"Select label");
            contactPage.goSpinToWork();
        }catch (NoSuchElementException exception){
    ...
    public void validateContactEmail(){
        try {
            ...
            contactPage.sendKeysToContactEmail("test@mail.com");
        }catch (NoSuchElementException exception){
    ...
    // Email Field'ının yanındaki Spinner'ı açıp accountu Work seçerek kaydetme kontrolü
    @Test(priority = 9)
    public void validateWorkForContactEmail(){
        try{
    ...
    public void validateChecksNewContact(){
        try{
            ...
            Assert.assertEquals(homePage.dynamicCheckSavedName("work account").getText(),"work account");
        }catch (NoSuchElementException exception){
