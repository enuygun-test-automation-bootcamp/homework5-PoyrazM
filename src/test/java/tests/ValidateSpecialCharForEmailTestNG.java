...
public class ValidateSpecialCharForEmailTestNG extends BaseTest {
    ...
    public void validateContactName(){
        try {
            ...
            contactPage.sendKeysToContactName("special email");
        }catch (NoSuchElementException exception){
    ...
    public void validateContactPhone(){
        try {
            ...
            contactPage.sendKeysToContactPhone("12345647");
        }catch (NoSuchElementException exception){
    ...
    // Burada test case'm , email adresi göndereceğim texte özel karakter gönderme casesiydi
    @Test(priority = 8)
    ...
    public void validateChecksNewContact(){
        try{
            ...
            Assert.assertEquals(homePage.dynamicCheckSavedName("special email").getText(),"special email");
        }catch (NoSuchElementException exception){
