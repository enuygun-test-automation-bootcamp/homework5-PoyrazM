...
public class ValidateSpecialCharForNumberTestNG extends BaseTest {
    ...
    public void validateContactName(){
        try {
            ...
            contactPage.sendKeysToContactName("special number");
        }catch (NoSuchElementException exception){
    ...
    // Buradaki test case'm numara kısmına özel karakter gönderme case'siydi.
    @Test(priority = 6)
    public void validateContactPhone(){
        try {
            ...
            contactPage.sendKeysToContactPhone("*&%-_");
        }catch (NoSuchElementException exception){
    ...
    public void validateContactEmail(){
        try {
            ...
            contactPage.sendKeysToContactEmail("test7@mail.com");
        }catch (NoSuchElementException exception){
    ...
    public void validateChecksNewContact(){
        try{
            ...
            Assert.assertEquals(homePage.dynamicCheckSavedName("*&%-_").getText(),"*&%-_");
        }catch (NoSuchElementException exception){
