...
public class ValidateMobileAccountTestNG extends BaseTest{
    ...
    // Kişi eklediğim zaman kişinin ekleneceği mail hesabının kontrolü yapılmıştır
    @Test(priority = 4)
    ...
    public void validateContactName(){
        try {
            ...
            contactPage.sendKeysToContactName("i am tester");
        }catch (NoSuchElementException exception){
    ...
    public void validateContactPhone(){
        try {
            ...
            contactPage.sendKeysToContactPhone("0587412532");
        }catch (NoSuchElementException exception){
    ...
    // Phone Field'ın yanındaki Spinner'ı açıp accountu Mobile seçerek kaydetme kontrolü
    @Test(priority = 7)
    public void validateMobileForContactPhone(){
        try{
            contactPage.clickToPhoneSpinner();
            Assert.assertEquals(contactPage.getAlertTitleText().getText(),"Select label");
            contactPage.goSpinToMobile();
        }catch (NoSuchElementException exception){
    ...
    public void validateContactEmail(){
        try {
            ...
            contactPage.sendKeysToContactEmail("test2@mail.com");
        }catch (NoSuchElementException exception){
    ...
    // Email Field'ının yanındaki Spinner'ı açıp accountu Mobile seçerek kaydetme kontrolü
    @Test(priority = 9)
    public void validateMobileForContactEmail(){
        try{
    ...
    public void validateChecksNewContact(){
        try{
            ...
            Assert.assertEquals(homePage.dynamicCheckSavedName("i am tester").getText(),"i am tester");
        }catch (NoSuchElementException exception){
