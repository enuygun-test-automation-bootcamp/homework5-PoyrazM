...
Appium için verilen her bir test case için test otomasyonu yazım işlemleri yapılmıştır. Bütün Page , Test ve Set-Up kodları src/test/java ve src/test/resources altındadır.
